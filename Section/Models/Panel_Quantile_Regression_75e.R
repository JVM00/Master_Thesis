...
#rq_fit <- rq(def_model_ALL,  tau = seq(0.1,0.9,0.1),data = npl_hh.75e)
...
# 
# #rq_summ1 <- summary(rq_fit1 ,se="boot", bsmethod="cluster",cluster= npl_hh.75e$name )
...
View(R2rq_npl_hh.75e.nfi)
View(R2rq_npl_fi.75e)
View(R2rq_npl_nfi.75e)

path_data <- 'C:/Users/varga/Desktop/Thesis/R_data/Data/'
#save(QR_npl_hh.75e.nfi,file=paste(path_data,'QR_npl_hh.75e.nfi.RData', sep = ""))
save(QR_npl_hh.75e,file=paste(path_data,'QR_npl_hh.75e.RData', sep = ""))
save(QR_npl_nfi.75e,file=paste(path_data,'QR_npl_nfi.75e.RData', sep = ""))
save(QR_npl_fi.75e,file=paste(path_data,'QR_npl_fi.75e.RData', sep = ""))
...
#anova <- list(ANOVA_npl_hh.75e=ANOVA_npl_hh.75e,ANOVA_npl_fi.75e=ANOVA_npl_fi.75e,ANOVA_npl_nfi.75e=ANOVA_npl_nfi.75e)

#anova <- list(ANOVA_npl_hh.75e.nfi=ANOVA_npl_hh.75e.nfi,ANOVA_npl_fi.75e=ANOVA_npl_fi.75e)
anova <- list(ANOVA_npl_hh.75e=ANOVA_npl_hh.75e,ANOVA_npl_nfi.75e=ANOVA_npl_nfi.75e,ANOVA_npl_fi.75e=ANOVA_npl_fi.75e)
class(anova)
anova[1]
#anova <- list(ANOVA_npl_fi.75e=ANOVA_npl_fi.75e)

#anova <- list(ANOVA_npl_hh.75e.nfi=ANOVA_npl_hh.75e.nfi)
...
# 
# anova_names <- c("Df","Resi Df","F-stat","P-val")
# names(ANOVA_npl_hh.75e.coef) <- anova_names
# 
# ANOVA_npl_hh.75e.coef[3] <- round(ANOVA_npl_hh.75e.coef[3],4)
# ANOVA_npl_hh.75e.coef[4] <- round(ANOVA_npl_hh.75e.coef[4],5)
# 
...
QR_npl_hh.75e <- QR_npl_hh.75e %>% mutate(Exposure = "Households")
QR_npl_nfi.75e <- QR_npl_nfi.75e %>% mutate(Exposure = "Non-Financial Corp.")
QR_npl_fi.75e <- QR_npl_fi.75e %>% mutate(Exposure = "Financial Corp.")

QR_npl <- as.data.frame(bind_rows(QR_npl_hh.75e,QR_npl_nfi.75e,QR_npl_fi.75e))
View(QR_npl)
...
# quantile(npl_hh.75e$NPL_ratio,seq(.1,.9,.1))
# summary(npl_hh.75e$NPL_ratio)
# stat.desc(npl_hh.75e$NPL_ratio)
#qqnorm(npl_hh.75e$NPL_ratio, pch = 1, frame = FALSE)
...
View(QRFE1_npl_hh.75e.nfi)

path_data <- 'C:/Users/varga/Desktop/Thesis/R_data/Data/'

save(QRFE1_npl_fi.75e,file=paste(path_data,'QRFE1_npl_fi.75e.RData', sep = ""))
save(QRFE1_npl_hh.75e,file=paste(path_data,'QRFE1_npl_hh.75e.RData', sep = ""))
save(QRFE1_npl_nfi.75e,file=paste(path_data,'QRFE1_npl_nfi.75e.RData', sep = ""))
...
path_data <- 'C:/Users/varga/Desktop/Thesis/R_data/Data/'
save(QRFE5_npl_hh.75e.nfi,file=paste(path_data,'QRFE5_npl_hh.75e.nfi.RData', sep = ""))
save(QRFE5_npl_fi.75e,file=paste(path_data,'QRFE5_npl_fi.75e.RData', sep = ""))

save(QRFE5_npl_hh.75e,file=paste(path_data,'QRFE5_npl_hh.75e.RData', sep = ""))
save(QRFE5_npl_nfi.75e,file=paste(path_data,'QRFE5_npl_nfi.75e.RData', sep = ""))
...
path_data <- 'C:/Users/varga/Desktop/Thesis/R_data/Data/'
#save(QRFE2.5_npl_hh.75e.nfi,file=paste(path_data,'QRFE2.5_npl_hh.75e.nfi.RData', sep = ""))
save(QRFE2.5_npl_fi.75e,file=paste(path_data,'QRFE2.5_npl_fi.75e.RData', sep = ""))

save(QRFE2.5_npl_hh.75e,file=paste(path_data,'QRFE2.5_npl_hh.75e.RData', sep = ""))
save(QRFE2.5_npl_nfi.75e,file=paste(path_data,'QRFE2.5_npl_nfi.75e.RData', sep = ""))


# 
# 
# pfe2.fit1 <- rqpd(de_model_ALL_rqpd, panel(lambda = 1,taus= seq(.1,.9,.1),tauw=rep(1/9,9),method="pfe"), data=npl_hh.75e, control=sfn.control(tmpmax=20*nrow(npl_hh.75e)) )
# 
# pfe2.summ1 <- summary.rqpd(pfe2.fit1, se = "boot",covariance = TRUE)
# 
# # qqplot(npl_hh.75e$NPL_ratio)
# # library("car")
# # qqPlot(npl_hh.75e$NPL_ratio)
# 
# 
...
# library(sdcMicro)
# 
# # npl_hh.75e1 <- npl_hh.75e
# # npl_hh.75e_1 <- addNoise(data.frame(npl_hh.75e), variables =  c("NPL_ratio","CET1_ratio_tr","LEVER_tr_ratio_imput", "RORAC","BankSize_tran_imput", "Cost_to_Income" ,      "NIM_tr_imput"  ,       "Stgth_legal_index" ,   "Reco_rate_dol"    ,    "infl_perc"   ,        
# #                                                         "curr_acc_bal"   , "GDP_growth_perc"   ,"unempl_rate_imf"  , "gross_public_debt"   ,          
# #   
# #                                                                                                                                                         "CBDI_index"   ) , noise = 20,method = "additive") 
# # npl_hh.75e2 <-   data.frame( npl_hh.75e_1$xm    )    
# 
# #names(npl_hh.75e[all.vars(def_model_ALL)])
# npl_hh.75e$NPL_ratio
#  options(dplyr.width = Inf)
# 
# cre.fit1 <- rqpd(de_model_ALL_rqpd_cre, panel(taus= seq(.25,.75,.25), method="cre",cre="crem"), 
#                  data=npl_hh.75e,control=sfn.control(tmpmax=2.5*nrow(npl_hh.75e),small=0.000000000000001,cachsz=100))
# cre.fit2 <- rqpd(de_model_ALL_rqpd_cre, panel( method="cre",cre="m"), data=p1)
# cre.fit3 <- rqpd(de_model_ALL_rqpd_cre, panel(taus= .5, method="cre",cre="crem"), data=npl_hh.75e)
# cre.fit4 <- rqpd(de_model_ALL_rqpd_cre, panel(taus= 0.75, method="cre",cre="crem"), data=npl_hh.75e)
# cre.fit5 <- rqpd(de_model_ALL_rqpd_cre, panel(taus= 0.9, method="cre",cre="crem"), data=npl_hh.75e)
# 
