...
for (i in names(sets)){
  ...
  assign(paste("m1.tn_",d, sep= ""),m1.tn)
  assign(paste("m1.pvalue_",d, sep= ""),m1.pvalue)
  ...
  assign(paste("si.tn_",d, sep= ""),si.tn)
  assign(paste("si.pvalue_",d, sep= ""),si.pvalue)
...
save(QR_npl_hh.nfi,file=paste(path_data,'QR_npl_hh.nfi.RData', sep = ""))
save(QR_npl_hh,file=paste(path_data,'QR_npl_hh.RData', sep = ""))
save(QR_npl_nfi,file=paste(path_data,'QR_npl_nfi.RData', sep = ""))
save(QR_npl_fi,file=paste(path_data,'QR_npl_fi.RData', sep = ""))
...
m1.tn_all <- list(m1.tn_npl_hh,m1.tn_npl_fi,m1.tn_npl_nfi)
m1.pvalue_all <- list(m1.pvalue_npl_hh,m1.pvalue_npl_fi,m1.pvalue_npl_nfi)
  
si.tn_all <- list(si.tn_npl_hh,si.tn_npl_fi,si.tn_npl_nfi)
si.pvalue_all <- list(si.pvalue_npl_hh,si.pvalue_npl_fi,si.pvalue_npl_nfi)
...
for (i in names(sets)){
 ...
 # j <- c("Households \& Non-Financial Corporations","Financial Corporations")
  ...
  m1.tn <- m1.tn_all[[c]]
  m1.pvalue <- m1.pvalue_all[[c]]
  si.tn <- si.tn_all[[c]]
  si.pvalue <- si.pvalue_all[[c]]
...
save(QRFE1_npl_fi,file=paste(path_data,'QRFE1_npl_fi.RData', sep = ""))

save(QRFE1_npl_hh,file=paste(path_data,'QRFE1_npl_hh.RData', sep = ""))
save(QRFE1_npl_nfi,file=paste(path_data,'QRFE1_npl_nfi.RData', sep = ""))
...
path_data <- 'C:/Users/varga/Desktop/Thesis/R_data/Data/'
save(QRFE5_npl_hh.nfi,file=paste(path_data,'QRFE5_npl_hh.nfi.RData', sep = ""))
save(QRFE5_npl_fi,file=paste(path_data,'QRFE5_npl_fi.RData', sep = ""))

save(QRFE5_npl_hh,file=paste(path_data,'QRFE5_npl_hh.RData', sep = ""))
save(QRFE5_npl_nfi,file=paste(path_data,'QRFE5_npl_nfi.RData', sep = ""))
...
save(QRFE2.5_npl_fi,file=paste(path_data,'QRFE2.5_npl_fi.RData', sep = ""))

save(QRFE2.5_npl_hh,file=paste(path_data,'QRFE2.5_npl_hh.RData', sep = ""))
save(QRFE2.5_npl_nfi,file=paste(path_data,'QRFE2.5_npl_nfi.RData', sep = ""))
