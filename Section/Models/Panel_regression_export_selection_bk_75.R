...
#Households
re.1 <-  RE_bk_75_plm$npl_hh.75
fe.1 <- FE_bk_75_plm$npl_hh.75
sysgmm.1 <-  sysgmm4_bk_75_plm$npl_hh.75

#Non-Financial Institutions
re.2 <-  RE_bk_75_plm$npl_nfi.75
fe.2 <-  FE_bk_75_plm$npl_nfi.75
#diffgmm.2 <- diffgmm2_plm$npl_nfi
diffgmm.2 <- sysgmm4_bk_75_plm$npl_nfi.75

#Financial Institutions
re.3 <-  RE_bk_75_plm$npl_fi.75
fe.3 <- FE_bk_75_plm$npl_fi.75

#diffgmm.3 <- diffgmm2_plm$npl_fi
diffgmm.3 <- sysgmm4_bk_75_plm$npl_fi.75
...
haus_test.hh <- phtest(FE_bk_75_plm[[1]], RE_bk_75_plm[[1]])
haus_test.fi <-phtest(FE_bk_75_plm[[2]], RE_bk_75_plm[[2]])
haus_test.nfi <-phtest(FE_bk_75_plm[[3]], RE_bk_75_plm[[3]])
...
# diffgmm.3 <- diffgmm2_plm$npl_fi
  ...
  stargazer(re.1,  fe.1,re.2 ,fe.2 , re.3,fe.3,sysgmm.1, diffgmm.2,diffgmm.3,title="Panel Data Models  (2014-2019)",
            ...
            #add.lines = list(st1,ar1,ar2),
             out="Research_Proposal/Progress/Tables/Final/Panel/Static_Models_SELEC_bk_75.tex")
  ...
  capture.output( stargazer(re.1,  fe.1,re.2 ,fe.2 , re.3,fe.3,sysgmm.1, diffgmm.2,diffgmm.3, title="Panel Data Models (2014-2019)",
                        ...
                        add.lines = list(ht,ht.star,st,st.star,ar1,ar1.star,ar2,ar2.star),
                        #add.lines = list(st1,ar1,ar2),
                           out="Research_Proposal/Progress/Tables/Final/Panel/Static_Models_SELEC_bk_75.html"))
