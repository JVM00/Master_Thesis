...
#Households
re.1 <-  RE_bk_plm$npl_hh
fe.1 <- FE_bk_plm$npl_hh
sysgmm.1 <-  sysgmm4_bk_plm$npl_hh

#Non-Financial Institutions
re.2 <-  RE_bk_plm$npl_nfi
fe.2 <-  FE_bk_plm$npl_nfi
#diffgmm.2 <- diffgmm2_plm$npl_nfi
diffgmm.2 <- sysgmm4_bk_plm$npl_nfi

#Financial Institutions
re.3 <-  RE_bk_plm$npl_fi
fe.3 <- FE_bk_plm$npl_fi
...
haus_test.hh <- phtest(FE_bk_plm[[1]], RE_bk_plm[[1]])
haus_test.fi <-phtest(FE_bk_plm[[2]], RE_bk_plm[[2]])
haus_test.nfi <-phtest(FE_bk_plm[[3]], RE_bk_plm[[3]])
...
# diffgmm.3 <- diffgmm2_plm$npl_fi
  ...
  stargazer(re.1,  fe.1,re.2 ,fe.2 , re.3,fe.3,sysgmm.1, diffgmm.2,diffgmm.3,title="Panel Data Models  (2014-2019)",
            ...
            #add.lines = list(st1,ar1,ar2),
             out="Research_Proposal/Progress/Tables/Final/Panel/Static_Models_SELEC_bk.tex")
  ...
  capture.output( stargazer(re.1,  fe.1,re.2 ,fe.2 , re.3,fe.3,sysgmm.1, diffgmm.2,diffgmm.3, title="Panel Data Models (2014-2019)",
                        ...
                        add.lines = list(ht,ht.star,st,st.star,ar1,ar1.star,ar2,ar2.star),
                        #add.lines = list(st1,ar1,ar2),
                           out="Research_Proposal/Progress/Tables/Final/Panel/Static_Models_SELEC_bk.html"))
