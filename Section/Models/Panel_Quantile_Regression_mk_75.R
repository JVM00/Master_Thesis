...
for (i in names(sets.75)){
  ...
  assign(paste("QR_mk_75_",d, sep= ""), l)
...
# QR_npl_hh.nfi_mk_75<- QR_npl_hh.nfi
# QR_npl_hh_mk_75<- QR_npl_hh
# QR_npl_nfi_mk_75<- QR_npl_nfi
# QR_npl_fi_mk_75 <- QR_npl_fi

path_data <- 'C:/Users/varga/Desktop/Thesis/R_data/Data/'
#save(QR_mk_75_npl_hh.nfi,file=paste(path_data,'QR_npl_hh.nfi_mk.RData', sep = ""))
save(QR_mk_75_npl_hh.75,file=paste(path_data,'QR_mk_75_npl_hh.75.RData', sep = ""))
save(QR_mk_75_npl_nfi.75,file=paste(path_data,'QR_mk_75_npl_nfi.75.RData', sep = ""))
save(QR_mk_75_npl_fi.75,file=paste(path_data,'QR_mk_75_npl_fi.75.RData', sep = ""))
 ...
 # tests <- list(m1.tn ,m1.pvalue,si.tn,si.pvalue,si1.tn,si1.pvalue,si2.tn,si2.pvalue,si3.tn,si3.pvalue,si4.tn,si4.pvalue)
  ...
  stargazer( rq_fit1, rq_fit2,rq_fit3,rq_fit4,rq_fit5,rq_fit6,rq_fit7,rq_fit8,rq_fit9,rq.se = "boot",
            ...
            add.lines = list(l,m1.tn ,m1.pvalue,si.tn,si.pvalue),
             digits=3, align=T, title= paste("Quantil Regression (2014-2019):",k,sep=" "),
             out=paste("Research_Proposal/Progress/Tables/Final/quantil/Quantil_Regression_mk_75_",d,".html", sep = ""))
  ...
  capture.output(stargazer( rq_fit1, rq_fit2,rq_fit3,rq_fit4,rq_fit5,rq_fit6,rq_fit7,rq_fit8,rq_fit9,rq.se = "boot",
                            ...
                            add.lines = list(l,m1.tn ,m1.pvalue,si.tn,si.pvalue),
                            digits=3, align=T, title= paste("Quantil Regression (2014-2019):",k,sep=" ")
                            ,out=paste("Research_Proposal/Progress/Tables/Final/quantil/Quantil_Regression_mk_75_",d,".tex", sep = "")))
} 
...
for (i in names(anova)){
 ...
 print.xtable(  df1, caption.placement = 'top' ,align= "c",booktabs = T,size = "small", include.rownames= TRUE,type="HTML",
                 file= paste("Research_Proposal/Progress/Tables/Final/quantil/Slope Test_mk_75_",d,".html", sep = ""))
print.xtable(  df1, caption.placement = 'top' ,align= "c",booktabs = T,size = "small", include.rownames= TRUE,type="latex",
                 file= paste("Research_Proposal/Progress/Tables/Final/quantil/Slope Test_mk_75_",d,".tex", sep = ""))
...
for (i in names(sets.75)){
  ...
  pfe.name<- names(npl_hh[all.vars(de_model_MACR_rqpd)])
 ...
 # class( pfe2.table2$pfe.types)
  ...
  assign(paste("QRFE1_mk_75_",d, sep= ""),pfe2.table2)
  # View(QRFE_npl_hh)
 ...
 # x <- xtable(pfe3.table2, caption = paste("A Fixed Effects Quantile Regression (2014-2019)[$\lambda = 1$]:",k,sep=" "))
  ...
  print.xtable(  x, caption.placement = 'top' ,align= "c",booktabs = T,size = "small", include.rownames= TRUE,type="HTML",
                 file= paste("Research_Proposal/Progress/Tables/Final/quantil/QRFE1_mk_75_",d,lambda,".html", sep = ""))
  print.xtable(  x, caption.placement = 'top' ,align= "c",booktabs = T,size = "small", include.rownames= TRUE,type="latex",
                 file= paste("Research_Proposal/Progress/Tables/Final/quantil/QRFE1_mk_75_",d,lambda,".tex", sep = ""))
...
path_data <- 'C:/Users/varga/Desktop/Thesis/R_data/Data/'
save(QRFE1_mk_75_npl_hh.nfi,file=paste(path_data,'QRFE1_npl_hh.nfi_mk_75.RData', sep = ""))
save(QRFE1_mk_75_npl_fi.75,file=paste(path_data,'QRFE1_mk_75_npl_fi.75.RData', sep = ""))

save(QRFE1_mk_75_npl_hh.75,file=paste(path_data,'QRFE1_mk_75_npl_hh.75.RData', sep = ""))
save(QRFE1_mk_75_npl_nfi.75,file=paste(path_data,'QRFE1_mk_75_npl_nfi.75.RData', sep = ""))
...
ggplot(QRFE1_npl_fi, aes(x=pfe.types)) + 
  xlab("Quantile(%)") +
  ylab(" ")+
  facet_wrap(~ pfe.row.names_mod,scales = "free")+
  geom_line(aes(y = Value), color = "black",size=.6) + 
...
ggplot(QRFE1_npl_nfi, aes(x=pfe.types)) + 
  xlab("Quantile(%)") +
  ylab(" ")+
  facet_wrap(~ pfe.row.names_mod,scales = "free")+
  geom_line(aes(y = Value), color = "black",size=.6) + 
...
for (i in names(sets.75)){
 ...
 # j <- c("Households & Non-Financial Corporations","Financial Corporations")
  ...
  pfe.name<- names(npl_hh.75[all.vars(de_model_MACR_rqpd)])
  ...
  assign(paste("QRFE5_mk_75_",d, sep= ""),pfe2.table2)
  # View(QRFE_npl_hh.75)
  ...
  print.xtable(  x, caption.placement = 'top' ,align= "c",booktabs = T,size = "small", include.rownames= TRUE,type="HTML",
                 file= paste("Research_Proposal/Progress/Tables/Final/quantil/QRFE5_mk_75_",d,lambda,".html", sep = ""))
  print.xtable(  x, caption.placement = 'top' ,align= "c",booktabs = T,size = "small", include.rownames= TRUE,type="latex",
                 file= paste("Research_Proposal/Progress/Tables/Final/quantil/QRFE5_mk_75_",d,lambda,".tex", sep = ""))
}

path_data <- 'C:/Users/varga/Desktop/Thesis/R_data/Data/'
#save(QRFE5_mk_75_npl_hh.75.nfi,file=paste(path_data,'QRFE5_npl_hh.75.nfi_mk_75.RData', sep = ""))
save(QRFE5_mk_75_npl_fi.75,file=paste(path_data,'QRFE5_mk_75_npl_fi.75.RData', sep = ""))

save(QRFE5_mk_75_npl_hh.75,file=paste(path_data,'QRFE5_mk_75_npl_hh.75.RData', sep = ""))
save(QRFE5_mk_75_npl_nfi.75,file=paste(path_data,'QRFE5_mk_75_npl_nfi.75.RData', sep = ""))
...
ggplot(QRFE5_npl_fi, aes(x=pfe.types)) + 
  xlab("Quantile(%)") +
  ylab(" ")+
  facet_wrap(~ pfe.row.names_mod,scales = "free")+
  geom_line(aes(y = Value), color = "black",size=.6) + 
...
ggplot(QRFE_npl_nfi, aes(x=pfe.types)) + 
  xlab("Quantile(%)") +
  ylab(" ")+
  facet_wrap(~ pfe.row.names_mod,scales = "free")+
  geom_line(aes(y = Value), color = "black",size=.6) + 
...
for (i in names(sets.75)){
  ...
  assign(paste("QRFE2.5_mk_75_",d, sep= ""),pfe2.table2)
  # View(QRFE_npl_hh.75)
  ...
  print.xtable(  x, caption.placement = 'top' ,align= "c",booktabs = T,size = "small", include.rownames= TRUE,type="HTML",
                 file= paste("Research_Proposal/Progress/Tables/Final/quantil/QRFE25_mk_75_",d,lambda,".html", sep = ""))
  print.xtable(  x, caption.placement = 'top' ,align= "c",booktabs = T,size = "small", include.rownames= TRUE,type="latex",
                 file= paste("Research_Proposal/Progress/Tables/Final/quantil/QRFE25_mk_75_",d,lambda,".tex", sep = ""))
}
...
#   
#   print.xtable(  x, caption.placement = 'top' ,align= "c",booktabs = T,size = "small", include.rownames= TRUE,type="HTML",
#                  file= paste("Research_Proposal/Progress/Tables/Final/quantil/QRFE2.5_mk_75_",d,lambda,".html", sep = ""))
#   print.xtable(  x, caption.placement = 'top' ,align= "c",booktabs = T,size = "small", include.rownames= TRUE,type="latex",
#                  file= paste("Research_Proposal/Progress/Tables/Final/quantil/QRFE2.5_mk_75_",d,lambda,".tex", sep = ""))
# }

path_data <- 'C:/Users/varga/Desktop/Thesis/R_data/Data/'
#save(QRFE2.5_mk_75_npl_hh.75.nfi,file=paste(path_data,'QRFE2.5_npl_hh.75.nfi_mk_75.RData', sep = ""))
save(QRFE2.5_mk_75_npl_fi.75,file=paste(path_data,'QRFE2.5_mk_75_npl_fi.75.RData', sep = ""))

save(QRFE2.5_mk_75_npl_hh.75,file=paste(path_data,'QRFE2.5_mk_75_npl_hh.75.RData', sep = ""))
save(QRFE2.5_mk_75_npl_nfi.75,file=paste(path_data,'QRFE2.5_mk_75_npl_nfi.75.RData', sep = ""))
...
ggplot(QRFE2.5_npl_fi, aes(x=pfe.types)) + 
  xlab("Quantile(%)") +
  ylab(" ")+
  facet_wrap(~ pfe.row.names_mod,scales = "free")+
  geom_line(aes(y = Value), color = "black",size=.6) + 
...
# 
# # npl_hh1 <- npl_hh
# # npl_hh_1 <- addNoise(data.frame(npl_hh), variables =  c("NPL_ratio","CET1_ratio_tr","LEVER_tr_ratio_imput", "RORAC","MACRSize_tran_imput", "Cost_to_Income" ,      "NIM_tr_imput"  ,       "Stgth_legal_index" ,   "Reco_rate_dol"    ,    "infl_perc"   ,        
