...
# QR_npl_hh.nfi_bk<- QR_npl_hh.nfi
# QR_npl_hh_bk<- QR_npl_hh
# QR_npl_nfi_bk<- QR_npl_nfi
# QR_npl_fi_bk <- QR_npl_fi

path_data <- 'C:/Users/varga/Desktop/Thesis/R_data/Data/'
save(QR_mk_npl_hh.nfi,file=paste(path_data,'QR_npl_hh.nfi_mk.RData', sep = ""))
save(QR_mk_npl_hh,file=paste(path_data,'QR_npl_hh_mk.RData', sep = ""))
save(QR_mk_npl_nfi,file=paste(path_data,'QR_npl_nfi_mk.RData', sep = ""))
save(QR_mk_npl_fi,file=paste(path_data,'QR_npl_fi_mk.RData', sep = ""))
 ...
 # tests <- list(m1.tn ,m1.pvalue,si.tn,si.pvalue,si1.tn,si1.pvalue,si2.tn,si2.pvalue,si3.tn,si3.pvalue,si4.tn,si4.pvalue)
  ...
  stargazer( rq_fit1, rq_fit2,rq_fit3,rq_fit4,rq_fit5,rq_fit6,rq_fit7,rq_fit8,rq_fit9,rq.se = "boot",
            ...
            add.lines = list(l,m1.tn ,m1.pvalue,si.tn,si.pvalue),
             digits=3, align=T, title= paste("Quantil Regression (2014-2019):",k,sep=" "),
             out=paste("Research_Proposal/Progress/Tables/Final/quantil/Quantil_Regression_mk_",d,".html", sep = ""))
  ...
  capture.output(stargazer( rq_fit1, rq_fit2,rq_fit3,rq_fit4,rq_fit5,rq_fit6,rq_fit7,rq_fit8,rq_fit9,rq.se = "boot",
                            ...
                            add.lines = list(l,m1.tn ,m1.pvalue,si.tn,si.pvalue),
                            digits=3, align=T, title= paste("Quantil Regression (2014-2019):",k,sep=" ")
                            ,out=paste("Research_Proposal/Progress/Tables/Final/quantil/Quantil_Regression_mk_",d,".tex", sep = "")))
} 
...
for (i in names(anova)){
 ...
 print.xtable(  df1, caption.placement = 'top' ,align= "c",booktabs = T,size = "small", include.rownames= TRUE,type="HTML",
                 file= paste("Research_Proposal/Progress/Tables/Final/quantil/Slope Test_mk_",d,".html", sep = ""))
print.xtable(  df1, caption.placement = 'top' ,align= "c",booktabs = T,size = "small", include.rownames= TRUE,type="latex",
                 file= paste("Research_Proposal/Progress/Tables/Final/quantil/Slope Test_mk_",d,".tex", sep = ""))
...
for (i in names(sets)){
 ...
 # class( pfe2.table2$pfe.types)
  ...
  assign(paste("QRFE1_mk_",d, sep= ""),pfe2.table2)
  # View(QRFE_npl_hh)
 ...
 # x <- xtable(pfe3.table2, caption = paste("A Fixed Effects Quantile Regression (2014-2019)[$\lambda = 1$]:",k,sep=" "))
  ...
  print.xtable(  x, caption.placement = 'top' ,align= "c",booktabs = T,size = "small", include.rownames= TRUE,type="HTML",
                 file= paste("Research_Proposal/Progress/Tables/Final/quantil/QRFE1_mk_",d,lambda,".html", sep = ""))
  print.xtable(  x, caption.placement = 'top' ,align= "c",booktabs = T,size = "small", include.rownames= TRUE,type="latex",
                 file= paste("Research_Proposal/Progress/Tables/Final/quantil/QRFE1_mk_",d,lambda,".tex", sep = ""))
...
path_data <- 'C:/Users/varga/Desktop/Thesis/R_data/Data/'
#save(QRFE1_mk_npl_hh.nfi,file=paste(path_data,'QRFE1_npl_hh.nfi_mk.RData', sep = ""))
save(QRFE1_mk_npl_fi,file=paste(path_data,'QRFE1_npl_fi_mk.RData', sep = ""))

save(QRFE1_mk_npl_hh,file=paste(path_data,'QRFE1_npl_hh_mk.RData', sep = ""))
save(QRFE1_mk_npl_nfi,file=paste(path_data,'QRFE1_npl_nfi_mk.RData', sep = ""))

# ggplot(QRFE1_npl_hh.nfi, aes(x=pfe.types)) + 
#   xlab("Quantile(%)") +
#   ylab(" ")+
...
for (i in names(sets)){
 ...
 # j <- c("Households & Non-Financial Corporations","Financial Corporations")
  ...
  assign(paste("QRFE5_mk_",d, sep= ""),pfe2.table2)
  # View(QRFE_npl_hh)
  ...
  print.xtable(  x, caption.placement = 'top' ,align= "c",booktabs = T,size = "small", include.rownames= TRUE,type="HTML",
                 file= paste("Research_Proposal/Progress/Tables/Final/quantil/QRFE5_mk_",d,lambda,".html", sep = ""))
  print.xtable(  x, caption.placement = 'top' ,align= "c",booktabs = T,size = "small", include.rownames= TRUE,type="latex",
                 file= paste("Research_Proposal/Progress/Tables/Final/quantil/QRFE5_mk_",d,lambda,".tex", sep = ""))
}

path_data <- 'C:/Users/varga/Desktop/Thesis/R_data/Data/'
#save(QRFE5_bk_npl_hh.nfi,file=paste(path_data,'QRFE5_npl_hh.nfi_bk.RData', sep = ""))
save(QRFE5_mk_npl_fi,file=paste(path_data,'QRFE5_npl_fi_mk.RData', sep = ""))

save(QRFE5_mk_npl_hh,file=paste(path_data,'QRFE5_npl_hh_mk.RData', sep = ""))
save(QRFE5_mk_npl_nfi,file=paste(path_data,'QRFE5_npl_nfi_mk.RData', sep = ""))

# #View(QRFE_npl_hh)
# ggplot(QRFE5_npl_hh.nfi, aes(x=pfe.types)) + 
#   xlab("Quantile(%)") +
#   ylab(" ")+
#   facet_wrap(~ pfe.row.names_mod,scales = "free")+
#   geom_line(aes(y = Value), color = "black",size=.6) + 
...
for (i in names(sets)){
  ...
  assign(paste("QRFE2.5_mk_",d, sep= ""),pfe2.table2)
  # View(QRFE_npl_hh)
  ...
  print.xtable(  x, caption.placement = 'top' ,align= "c",booktabs = T,size = "small", include.rownames= TRUE,type="HTML",
                 file= paste("Research_Proposal/Progress/Tables/Final/quantil/QRFE25_mk_",d,lambda,".html", sep = ""))
  print.xtable(  x, caption.placement = 'top' ,align= "c",booktabs = T,size = "small", include.rownames= TRUE,type="latex",
                 file= paste("Research_Proposal/Progress/Tables/Final/quantil/QRFE25_mk_",d,lambda,".tex", sep = ""))
}
...
#   # class( pfe2.table2$pfe.types)
#   
#   assign(paste("QRFE2.5_bk_",d, sep= ""),pfe2.table2)
#   # View(QRFE_npl_hh)
#   
#   for(j in 1:nrow(pfe2.table2)) {
#     pfe2.table2[j, 1] <- paste0(pfe2.table2[j, 1], starPrinter(cf_10.pVals[j]))
...
#   
#   print.xtable(  x, caption.placement = 'top' ,align= "c",booktabs = T,size = "small", include.rownames= TRUE,type="HTML",
#                  file= paste("Research_Proposal/Progress/Tables/Final/quantil/QRFE2.5_bk_",d,lambda,".html", sep = ""))
#   print.xtable(  x, caption.placement = 'top' ,align= "c",booktabs = T,size = "small", include.rownames= TRUE,type="latex",
#                  file= paste("Research_Proposal/Progress/Tables/Final/quantil/QRFE2.5_bk_",d,lambda,".tex", sep = ""))
# }

path_data <- 'C:/Users/varga/Desktop/Thesis/R_data/Data/'
save(QRFE2.5_mk_npl_hh.nfi,file=paste(path_data,'QRFE2.5_npl_hh.nfi_mk.RData', sep = ""))
save(QRFE2.5_mk_npl_fi,file=paste(path_data,'QRFE2.5_npl_fi_mk.RData', sep = ""))

save(QRFE2.5_mk_npl_hh,file=paste(path_data,'QRFE2.5_npl_hh_mk.RData', sep = ""))
save(QRFE2.5_mk_npl_nfi,file=paste(path_data,'QRFE2.5_npl_nfi_mk.RData', sep = ""))
