...
save(QR_Y_bk_npl_hh.nfi,file=paste(path_data,'QR_Y_bk_npl_hh.nfi.RData', sep = ""))
save(QR_Y_bk_npl_hh,file=paste(path_data,'QR_Y_bk_npl_hh.RData', sep = ""))
save(QR_Y_bk_npl_nfi,file=paste(path_data,'QR_Y_bk_npl_nfi.RData', sep = ""))
save(QR_Y_bk_npl_fi,file=paste(path_data,'QR_Y_bk_npl_fi.RData', sep = ""))
 ...
 # tests <- list(m1.tn ,m1.pvalue,si.tn,si.pvalue,si1.tn,si1.pvalue,si2.tn,si2.pvalue,si3.tn,si3.pvalue,si4.tn,si4.pvalue)
  ...
  stargazer( rq_fit1, rq_fit2,rq_fit3,rq_fit4,rq_fit5,rq_fit6,rq_fit7,rq_fit8,rq_fit9,rq.se = "boot",
            ...
            add.lines = list(l,m1.tn ,m1.pvalue,si.tn,si.pvalue),
             digits=3, align=T, title= paste("Quantil Regression (2014-2019):",k,sep=" "),
             out=paste("Research_Proposal/Progress/Tables/Final/quantil/Quantil_Regression_y_bk_",d,".html", sep = ""))
  ...
  capture.output(stargazer( rq_fit1, rq_fit2,rq_fit3,rq_fit4,rq_fit5,rq_fit6,rq_fit7,rq_fit8,rq_fit9,rq.se = "boot",
                            ...
                            add.lines = list(l,m1.tn ,m1.pvalue,si.tn,si.pvalue),
                            digits=3, align=T, title= paste("Quantil Regression (2014-2019):",k,sep=" ")
                            ,out=paste("Research_Proposal/Progress/Tables/Final/quantil/Quantil_Regression_y_bk_",d,".tex", sep = "")))
} 
...
for (i in names(anova)){
 ...
 print.xtable(  df1, caption.placement = 'top' ,align= "c",booktabs = T,size = "small", include.rownames= TRUE,type="HTML",
                 file= paste("Research_Proposal/Progress/Tables/Final/quantil/Slope Test_Y_bk_",d,".html", sep = ""))
print.xtable(  df1, caption.placement = 'top' ,align= "c",booktabs = T,size = "small", include.rownames= TRUE,type="latex",
                 file= paste("Research_Proposal/Progress/Tables/Final/quantil/Slope Test_Y_bk_",d,".tex", sep = ""))
...
QR_npl_hh <- QR_Y_bk_npl_hh %>%filter(!grepl('Year', var))%>%  mutate(Exposure = "Households")
QR_npl_nfi <- QR_Y_bk_npl_nfi %>%filter(!grepl('Year', var))%>% mutate(Exposure = "Non-Financial Corp.")
QR_npl_fi <- QR_Y_bk_npl_fi %>%filter(!grepl('Year', var))%>% mutate(Exposure = "Financial Corp.")
#View(QR_Y_bk_npl_hh)
#View(QR_Y_bk_npl_hh)
...
for (i in names(sets)){
  ...
  pfe.name<- names(npl_hh[all.vars(de_model_ALL_rqpd_Year_bk)])
 ...
 # class( pfe2.table2$pfe.types)
  ...
  assign(paste("QRFE1_Y_bk_",d, sep= ""),pfe2.table2)
  # View(QRFE_npl_hh)
 ...
 # x <- xtable(pfe3.table2, caption = paste("A Fixed Effects Quantile Regression (2014-2019)[$\lambda = 1$]:",k,sep=" "))
  ...
  print.xtable(  x, caption.placement = 'top' ,align= "c",booktabs = T,size = "small", include.rownames= TRUE,type="HTML",
                 file= paste("Research_Proposal/Progress/Tables/Final/quantil/QRFE_Y_bk_",d,lambda,".html", sep = ""))
  print.xtable(  x, caption.placement = 'top' ,align= "c",booktabs = T,size = "small", include.rownames= TRUE,type="latex",
                 file= paste("Research_Proposal/Progress/Tables/Final/quantil/QRFE_y_bk_",d,lambda,".tex", sep = ""))
...
save(QRFE1_Y_bk_npl_fi,file=paste(path_data,'QRFE1_Y_bk_npl_fi.RData', sep = ""))

save(QRFE1_Y_bk_npl_hh,file=paste(path_data,'QRFE1_Y_bk_npl_hh.RData', sep = ""))
save(QRFE1_Y_bk_npl_nfi,file=paste(path_data,'QRFE1_Y_bk_npl_nfi.RData', sep = ""))
...
QR_npl <- as.data.frame(bind_rows(QR_npl_hh,QR_npl_nfi,QR_npl_fi))
View(QRFE1_Y_bk_npl_fi)
pfe.row.names_mod

QRFE1_hh <- QRFE1_Y_bk_npl_hh %>%filter(!grepl('Year', pfe.row.names_mod))%>% mutate(Exposure = "Financial Corp.")
...
ggplot(QRFE_Y_bk_npl_nfi, aes(x=pfe.types)) + 
  xlab("Quantile(%)") +
  ylab(" ")+
  facet_wrap(~ pfe.row.names_mod,scales = "free")+
  geom_line(aes(y = Value), color = "black",size=.6) + 
...
for (i in names(sets)){
  ...
  assign(paste("QRFE5_Y_bk_",d, sep= ""),pfe2.table2)
  # View(QRFE_npl_hh)
...
path_data <- 'C:/Users/varga/Desktop/Thesis/R_data/Data/'
#save(QRFE1_npl_hh.nfi,file=paste(path_data,'QRFE1_npl_hh.nfi.RData', sep = ""))
save(QRFE5_Y_bk_npl_fi,file=paste(path_data,'QRFE5_Y_bk_npl_fi.RData', sep = ""))

save(QRFE5_Y_bk_npl_hh,file=paste(path_data,'QRFE5_Y_bk_npl_hh.RData', sep = ""))
save(QRFE5_Y_bk_npl_nfi,file=paste(path_data,'QRFE5_Y_bk_npl_nfi.RData', sep = ""))

QRFE5_hh <- QRFE5_Y_bk_npl_hh %>%filter(!grepl('Year', pfe.row.names_mod))%>% mutate(Exposure = "Financial Corp.")
...
for (i in names(sets)){
  ...
  assign(paste("QRFE2.5_Y_bk_",d, sep= ""),pfe2.table2)
  # View(QRFE_npl_hh)
...
path_data <- 'C:/Users/varga/Desktop/Thesis/R_data/Data/'
#save(QRFE1_npl_hh.nfi,file=paste(path_data,'QRFE1_npl_hh.nfi.RData', sep = ""))
save(QRFE2.5_Y_bk_npl_fi,file=paste(path_data,'QRFE2.5_Y_bk_npl_fi.RData', sep = ""))

save(QRFE2.5_Y_bk_npl_hh,file=paste(path_data,'QRFE2.5_Y_bk_npl_hh.RData', sep = ""))
save(QRFE2.5_Y_bk_npl_nfi,file=paste(path_data,'QRFE2.5_Y_bk_npl_nfi.RData', sep = ""))


QRFE2.5_hh <- QRFE2.5_Y_bk_npl_hh %>%filter(!grepl('Year', pfe.row.names_mod))%>% mutate(Exposure = "Financial Corp.")
